...
frmMain.NPC_AI.interval = val(txtAI.Text)
IntervaloUserPuedeTrabajar = val(txtTrabajo.Text)
User_AtacarMelee = val(txtPuedeAtacar.Text)
...
Dim ArchConfig As String

ArchConfig = "Intervalos.ini"

'Intervalos
Call WriteVar(IniPath & ArchConfig, "INTERVALOS", "SanaIntervaloSinDescansar", str(SanaIntervaloSinDescansar))
Call WriteVar(IniPath & ArchConfig, "INTERVALOS", "StaminaIntervaloSinDescansar", str(StaminaIntervaloSinDescansar))
Call WriteVar(IniPath & ArchConfig, "INTERVALOS", "SanaIntervaloDescansar", str(SanaIntervaloDescansar))
Call WriteVar(IniPath & ArchConfig, "INTERVALOS", "StaminaIntervaloDescansar", str(StaminaIntervaloDescansar))
Call WriteVar(IniPath & ArchConfig, "INTERVALOS", "IntervaloSed", str(IntervaloSed))
Call WriteVar(IniPath & ArchConfig, "INTERVALOS", "IntervaloHambre", str(IntervaloHambre))
Call WriteVar(IniPath & ArchConfig, "INTERVALOS", "IntervaloVeneno", str(IntervaloVeneno))
Call WriteVar(IniPath & ArchConfig, "INTERVALOS", "IntervaloParalizado", str(IntervaloParalizado))
Call WriteVar(IniPath & ArchConfig, "INTERVALOS", "IntervaloInvisible", str(IntervaloInvisible))
Call WriteVar(IniPath & ArchConfig, "INTERVALOS", "IntervaloFrio", str(IntervaloFrio))
Call WriteVar(IniPath & ArchConfig, "INTERVALOS", "IntervaloWAVFX", str(IntervaloWavFx))
Call WriteVar(IniPath & ArchConfig, "INTERVALOS", "IntervaloInvocacion", str(IntervaloInvocacion))
Call WriteVar(IniPath & ArchConfig, "INTERVALOS", "IntervaloParaConexion", str(IntervaloParaConexion))

'&&&&&&&&&&&&&&&&&&&&& TIMERS &&&&&&&&&&&&&&&&&&&&&&&

Call WriteVar(IniPath & ArchConfig, "INTERVALOS", "IntervaloNpcPuedeAtacar", frmMain.npcataca.interval)
Call WriteVar(IniPath & ArchConfig, "INTERVALOS", "IntervaloTrabajo", str(IntervaloUserPuedeTrabajar))
Call WriteVar(IniPath & ArchConfig, "INTERVALOS", "User_AtacarMelee", str(User_AtacarMelee))
