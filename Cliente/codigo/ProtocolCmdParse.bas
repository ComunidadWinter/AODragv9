...
'***************************************************
    ...
    If Left$(Comando, 1) = "/" Then
        ...
        Select Case Comando
            ...
            '27/10/2015 Irongete: Comando para mostrar los dueños de los castillos
            Case "/CASTILLOS"
                Call WriteCastillos
            ...
            Case "/BUSCARNPC"
                ...
                Else
                    Call ShowConsoleMsg("Faltan parámetros. Utilice /BuscarNPC npc.")
                End If
            ...
            Case "/ENTREGARDC"
                If notNullArguments Then
                    ...
                    End If
                Else
                    Call ShowConsoleMsg("Faltan parámetros. Utilice /ENTREGARDC NICKNAME@PUNTOS.")
                End If
