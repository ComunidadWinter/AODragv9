...
If GetSetting("AODRAG", "SERVIDOR", "ANUNCIO", 0) = 0 Then
    MsgBox "¡¡¡¡ATENCIÓN!!!! Ya están disponibles los servidores de España y Argentina, pueden cambiar a cual conectarse desde el selector de servidores de abajo. Ambos personajes se encuentran en los servidores.", vbExclamation
