...
Private Sub Image1_Click()
    ...
    Me.Label1.Caption = "No tienes suficientes DragCreditos. El grupo de facebook y en la sección Donaciones podrás obtener toda la información de como conseguir DragCreditos."
    End If
    ...
    Case "DRAC1"
    Me.Label1.Caption = "Ok!! Cambio realizado con éxito. Es posible que tengas que salir y volver a entrar al personaje para ver los cambios."
    Case "DRAC2"
    Me.Label1.Caption = "Ok!! Cambio realizado con éxito. Es posible que tengas que salir y volver a entrar al personaje para ver los cambios."
    Case "DRAC3"
    Me.Label1.Caption = "Ok!! Cambio realizado con éxito. Es posible que tengas que salir y volver a entrar al personaje para ver los cambios."
    ...
    Me.Label1.Caption = "Ok!! Cambio realizado con éxito. Es posible que tengas que salir y volver a entrar al personaje para ver los cambios."
    Case "DRAC7"
    Me.Label1.Caption = "Ok!! Has conseguido nuevas solicitudes de clan. Es posible que tengas que salir y volver a entrar al personaje para ver los cambios."
    Case "DRAC8"
