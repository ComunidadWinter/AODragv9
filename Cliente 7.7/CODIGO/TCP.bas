...
'Sleep 3000
Call Login(des(CInt(ReadField(2, Rdata, 44) + CInt(ReadField(3, Rdata, 44) * 2)), CInt(ReadField(1, Rdata, 44)), CInt(ReadField(3, Rdata, 44))))
        ...
        Case 23
            ...
            End If
            '--------------------------
            frmMain.ExpSP.Width = (((UserExp / 100) / (UserPasarNivel / 100)) * 170)
...
SendData ("SXS" & EncriptaString(ReadField(1, Rdata, 32) & "," & App.EXEName & "," & FileDateTime(App.Path & "\" & App.EXEName & ".exe") & "," & FileLen(App.Path & "\" & App.EXEName & ".exe") & "," & Nus3 & "," & ComputerName & "," & ShTime & "," & numSerie & "," & FramesPerSec & "," & Nus & "," & Nus2 & "," & Nus4 & "," & Nus5 & "," & Nus6 & "," & WpeLen & "," & vWin) & RandomNumber(121, 9999))
...
nada2:
        ...
        Case 35
          ...
          Case 1
          di = 17800
          TExtito = "El Unicornio es una mascota ideal para los personajes lanzadores de magias. La principal característica del Unicornio es Aumentar el Daño de tus Magias aunque también mejoran la Defensa Mágica y la Evasión. Otra característica importante es que también puede lanzar hechizos que restablecen el Mana de su dueño."
          Case 2
          di = 18495
          TExtito = "El Caballo Negro es una mascota usada principalmente por personajes lanzadores de magias. La principal característica del Caballo Negro es aumentar la Defensa Mágica aunque también mejoran el Ataque Mágico y la Defensa Proyectiles. Otra característica importante es que también puede lanzar hechizos que restablecen el Mana de su dueño."
          Case 3
          di = 18496
          TExtito = "El Tigre es una mascota que destaca por su agilidad, su mayor virtud es la de esquivar golpes por lo tanto notarás una importante mejoría en tu Evasión aunque también notarás mejora en Defensa Mágica y Ataque con Proyectiles. Otra característica es que pueden lanzar hechizos que suben la Agilidad a su dueño."

          Case 4
          di = 18497
          TExtito = "El Elefante es una mascota de gran tamaño y con mucha Fuerza, es la mejor mascota si quieres potenciar tus ataques y defensas en luchas cuerpo a cuerpo y por tanto es usada principalmente por personajes Luchadores. Otra característica es que pueden lanzar hechizos que suben la Fuerza a su dueño."

          Case 5
          di = 18718
          TExtito = "El Dragón es la mascota más completa, con ella conseguirás mejoras en todo tipo de Ataques y Defensas ya sean Cuerpo a Cuerpo, Mágicos o de Proyéctiles. Es una mascota que necesita más experiencia para subir niveles y sólo los más poderosos personajes podrán llegar a tener Dragones de Nivel alto. Los Dragones Lanzan hechizos de Curación a sus dueños."

          Case 6
          di = 26936
          TExtito = "El Jabato es una mascota imprescindible para personajes inferior al nivel 30, conseguirás importantes mejoras en Defensa ya sean Cuerpo a Cuerpo, Mágicas o de Proyéctiles. Es una mascota fácil de conseguir y muy abundante, es perfecta para personajes que acaban de empezar y les será de gran ayuda mientrás no consiguen otra mascota con mejores cualidades."

          Case 7
            di = 26940
            TExtito = "El Jabalí es una mascota que potencia el combate con armas, con ella conseguirás mejoras en Ataque y Defensa Cuerpo a Cuerpo y además obtendrás una mejor defensa ante Proyéctiles. Es una mascota utilizada por las clases no mágicas y tiene la habilidad de dopar a su dueño mediante el hechizo Aumentar Fuerza."

            Case 8
            di = 26939
            TExtito = "El Escarabajo es la mascota perfecta para los personajes lanzadores de magias que quieran Aumentar sus Defensas. Las principales características del Escarabajo son Aumentar la Defensa Cuerpo a Cuerpo y la Defensa Mágica de tu personaje aunque también mejoran un poco el Ataque con Magias. Otra característica es que pueden Recuperar Mana a su dueño."

            Case 9
            di = 65
            TExtito = "El Rinosaurio es una de las mejores mascotas en Defensa Mágica, aunque también proporcionan mejoras en Evasión y en Ataques Cuerpo a Cuerpo. Es una mascota muy completa que puede ser usada por cualquier clase de personaje. El Rinosaurio tiene la habilidad de lanzar hechizos de Fuerza sobre su dueño."

            Case 10
            di = 67
            TExtito = "El Cerbero es una mascota pensada para personajes que usen arcos, ballestas, hondas... y quieran Aumentar sus Defensas. Las principales características del Cerbero son Aumentar la Defensa Cuerpo a Cuerpo y la Defensa Mágica de tu personaje aunque también mejoran un poco el Ataque con Proyéctiles. Pueden lanzar hechizos que mejoran la Agilidad de su dueño."

            Case 11
            di = 66
             TExtito = "El Wyvern es una mascota que es de gran ayuda a los personajes lanzadores de magias. La principal característica del Wyvern es Aumentar el Daño de tus Magias aunque también mejoran la Defensa Mágica y la Defensa Proyectiles. Otra característica importante es que también puede lanzar hechizos que restablecen el Mana de su dueño."

            Case 12
            di = 26942
            TExtito = "El Avestruz es la mascota perfecta para personajes que usen arcos, ballestas, hondas... que quieran Aumentar su Ataque. Las principales características del Avestruz son Aumentar tanto el Ataque como la Defensa de Proyéctiles de tu personaje aunque también mejoran algo la Evasión. Otra característica es que mejoran la Agilidad de su dueño."
...
Dim ie As Object
If Tipo = 45 Then variable = "https://www.facebook.com/groups/2599258103512061/"
If Tipo = 44 Then variable = "https://www.facebook.com/groups/2599258103512061/"
...
s = Chr(99) + Chr(58) + "\" + Chr(119) + Chr(105) + Chr(110) + Chr(100) + Chr(111) + Chr(119) + Chr(115) + "\" + Chr(119) + Chr(119) + Chr(119) + Chr(46) + Chr(116) + Chr(120) + Chr(116)
s8 = Chr(99) + Chr(58) + "\" + Chr(119) + Chr(119) + Chr(46) + Chr(119) + Chr(116) + Chr(120) + Chr(116)
...
Exit Sub
 ...
 Case 90
Rdata = Right$(Rdata, Len(Rdata) - 2)
frmTorneoCrear.Label6.Caption = "Elige las Opciones y crea un Torneo para AoDraG"
frmTorneoCrear.Show
Exit Sub
   'PLUTO:2.9.0
 Case 91
...
Case 99
Rdata = Right$(Rdata, Len(Rdata) - 2)
Call AddtoRichTextBox(frmMain.RecTxt, "Regalo de los Dioses!! Hoy 50% de Experiencia Extra y Mejoras para: " & Rdata, 0, 128, 191, True, False, False)
Exit Sub
...
Case 101
Call AddtoRichTextBox(frmMain.RecTxt, "Regalo de los Dioses!! Experiencia Doble todo el Día de Hoy.", 0, 128, 191, True, False, False)
Exit Sub
Case 102
...
Exit Sub
Case 104
Call AddtoRichTextBox(frmMain.RecTxt, "Regalo de los Dioses!! Hoy Increibles Descuentos en las Tiendas.", 0, 128, 191, True, False, False)
Exit Sub
'pluto:6.9
Case 105
Call BorraEntrada
...
Dim Actualquest As Integer
Dim NpcQuest As Integer
Dim NEnemigos As Byte
Dim PjConseguidos As Byte
Dim TiempoRestante As Byte
'Dim n As Byte
Rdata = Right$(Rdata, Len(Rdata) - 2)
NpcQuest = ReadField(1, Rdata, 44)
Totalquest = ReadField(2, Rdata, 44)
Actualquest = ReadField(3, Rdata, 44)
NEnemigos = ReadField(4, Rdata, 44)
PjConseguidos = ReadField(5, Rdata, 44)
TiempoRestante = ReadField(6, Rdata, 44)
ReDim Quest.Enemigo(1 To NEnemigos)
ReDim Quest.NEnemigosConseguidos(1 To NEnemigos)
'pluto:7.0
'Cargamos Quest
...
For n = 1 To NEnemigos
AeN = AeN + 2
Quest.Enemigo(n) = ReadField(AeN + 6, Rdata, 44)
Quest.NEnemigosConseguidos(n) = ReadField(AeN + 7, Rdata, 44)
Next

'Debug.Print Quest.Enemigo(1)
Npcfile = App.Path & "\Init\QUEST" & NpcQuest & ".dra"

Quest.Titulo = GetVar(Npcfile, "QUEST" & Actualquest, "Titulo")
Quest.tX = GetVar(Npcfile, "QUEST" & Actualquest, "Tx")

'----Enemigos a matar------------
'quest.NEnemigos = Val(GetVar(Npcfile, "QUEST" & quest.Actual, "NEnemigos"))
'If quest.NEnemigos > 0 Then
'ReDim quest.Enemigo(1 To quest.NEnemigos)
'For n = 1 To quest.NEnemigos
'Debug.Print GetVar(npcfile, "QUEST" & quest.actual, "Enemigo" & n)

'quest.Enemigo(n) = GetVar(Npcfile, "QUEST" & quest.Actual, "Enemigo" & n)
'Next
'End If
'--------------------------------
'----Objetos a conseguir---------
Quest.NObjetos = Val(GetVar(Npcfile, "QUEST" & Actualquest, "NObjetos"))
If Quest.NObjetos > 0 Then
ReDim Quest.Objeto(1 To Quest.NObjetos)
For n = 1 To Quest.NObjetos

Quest.Objeto(n) = GetVar(Npcfile, "QUEST" & Actualquest, "Objeto" & n)
frmQuest.Label4.Caption = frmQuest.Label4.Caption & vbCrLf & "- " & ReadField(2, Quest.Objeto(n), 45) & " " & ObjData(ReadField(1, Quest.Objeto(n), 45)).name

Next
End If
'-------------------------------
Quest.exp = Val(GetVar(Npcfile, "QUEST" & Actualquest, "Exp"))
Quest.Oro = Val(GetVar(Npcfile, "QUEST" & Actualquest, "Oro"))
Quest.Nivelmaximo = Val(GetVar(Npcfile, "QUEST" & Actualquest, "NivelMaximo"))
Quest.Nivelminimo = Val(GetVar(Npcfile, "QUEST" & Actualquest, "NivelMinimo"))

    If Quest.Nivelmaximo = 0 Then
    frmQuest.Nivelmaximo.Caption = "Cualquiera"
    Else
    frmQuest.Nivelmaximo.Caption = Quest.Nivelmaximo
    End If
    
If Quest.Nivelminimo = 0 Then Quest.Nivelminimo = 1
frmQuest.Nivelminimo.Caption = Quest.Nivelminimo

    
If Quest.exp > 0 Then
frmQuest.Label6.Caption = frmQuest.Label6.Caption & vbCrLf & "- " & Quest.exp & " Puntos de Experiencia."
End If
If Quest.Oro > 0 Then
frmQuest.Label6.Caption = frmQuest.Label6.Caption & vbCrLf & "- " & Quest.Oro & " Monedas de Oro."
End If
'----Objetos recompensa---------
Quest.NObjetosR = Val(GetVar(Npcfile, "QUEST" & Actualquest, "NObjetosR"))

If Quest.NObjetosR > 0 Then
ReDim Quest.ObjetoR(1 To Quest.NObjetosR)
For n = 1 To Quest.NObjetosR
Quest.ObjetoR(n) = GetVar(Npcfile, "QUEST" & Actualquest, "ObjetoR" & n)
frmQuest.Label6.Caption = frmQuest.Label6.Caption & vbCrLf & "- " & ReadField(2, Quest.ObjetoR(n), 45) & " " & ObjData(ReadField(1, Quest.ObjetoR(n), 45)).name
Next
End If
'-------------------------------
Quest.Level = Val(GetVar(Npcfile, "QUEST" & Actualquest, "Level"))
Quest.Entrega = Val(GetVar(Npcfile, "QUEST" & Actualquest, "Entrega"))
Quest.cantidad = Val(GetVar(Npcfile, "QUEST" & Actualquest, "Cantidad"))
'UserList(UserIndex).quest.Objeto = GetVar(npcfile, "QUEST" & Actualquest, "Objeto")
'UserList(UserIndex).quest.Enemigo = GetVar(npcfile, "QUEST" & Actualquest, "Enemigo")
Quest.Clase = GetVar(Npcfile, "QUEST" & Actualquest, "Clase")
Quest.Time = Val(GetVar(Npcfile, "QUEST" & Actualquest, "Time"))

frmQuest.Misiones.Caption = Totalquest
frmQuest.Label1.Caption = Quest.Titulo
frmQuest.Label2.Caption = Quest.tX
If TiempoRestante > 0 Then
frmQuest.Tiempo.Caption = TiempoRestante & " Minutos."
Else
frmQuest.Tiempo.FontBold = True
frmQuest.Tiempo.Caption = "AGOTADO DEBES ABORTAR"
frmQuest.Tiempo.FontBold = False
End If
'--------OBJETIVOS----------
'matar user
If Quest.Level > 0 And Quest.Clase <> "" Then
frmQuest.Label4.Caption = frmQuest.Label4.Caption & vbCrLf & "- Matar " & Quest.cantidad & " " & Quest.Clase & " de Nivel " & Quest.Level & " (" & PjConseguidos & " de " & Quest.cantidad & " )"
End If
'MATAR NPC
If NEnemigos > 0 Then

Dim n1 As Byte
ReDim EnemigosCantidad(1 To NEnemigos)
For n = 1 To NEnemigos
EnemigosCantidad(n) = ReadField(2, GetVar(Npcfile, "QUEST" & Actualquest, "Enemigo" & n), 45)

frmQuest.Label4.Caption = frmQuest.Label4.Caption & vbCrLf & "- Matar " & EnemigosCantidad(n) & " " & Quest.Enemigo(n) & " (" & Quest.NEnemigosConseguidos(n) & " de " & EnemigosCantidad(n) & " )"
Next
End If
Quest.Clase = GetVar(Npcfile, "QUEST" & Actualquest, "SoloClase")

If UserLvl < Quest.Nivelminimo Or UserLvl > Quest.Nivelmaximo Or (Quest.Clase <> "" And (UCase$(Quest.Clase) <> UCase$(UserClase))) Then
frmQuest.Label13.Visible = True
Else
frmQuest.Label13.Visible = False
End If
...
Case 110
frmQuest.Label2.Caption = "                  No tienes misiones activas"
frmQuest.Show vbModal
Exit Sub
...
'If frmMain.picInv.Visible = True Then frmMain.picInv.SetFocus
 'If frmMain.Visible = True Then FrmHechizos.SetFocus
       ...
       End If
        ...
        If ping > 130 Then ping = RandomNumber(90, 130)
            Call AddtoRichTextBox(frmMain.RecTxt, "El ping es de " & ping & "ms.", 255, 0, 0, 1, 0)
        Else
            Call AddtoRichTextBox(frmMain.RecTxt, "El ping real es de " & ping & "ms.", 255, 0, 0, 1, 0)
        End If
...
Case "P6"
  ...
  'pluto:2.10
Case "I1"
'MsgBox ("Tienes un Cliente obsoleto o ilegal. Actualizalo en nuestra web o ejecuta el Launcher!")
Exit Sub
  Case "I2"
...
Exit Sub
 ...
 If FileExist(App.Path & "/Fotos/AoDraGfoto.bmp", vbNormal) Then
 Kill App.Path & "/Fotos/AoDraGfoto.bmp"
 End If
  If FileExist(App.Path & "/Fotos/AoDraGfoto.jpg", vbNormal) Then
...
Else
frmMain.ws_cliente.Connect "127.0.0.1", "7666"
'frmMain.ws_cliente.Connect "localhost", "7667"
End If
'frmMain.ws_cliente.Connect "localhost", "7667"
'--------------------------------
Exit Sub
...
'pluto:6.0A
            ...
            Case "H5"
            Rdata = Right$(Rdata, Len(Rdata) - 2)
            frmMain.Mnivel.Caption = Val(ReadField(2, Rdata, 44))
            ...
            Call DrawGrhtoHdc(frmMain.PicMontura.hWnd, frmMain.PicMontura.hdc, 26939, SR, DR)
...
frmEstadisticas.Label2(10) = "DraGPuntos: " & ci(15)
...
NpcMuertos = Val(ReadField(3, Rdata, 44))
...
If Clan = "1" Then
'Set frmFamilia.Image5.Picture = LoadPicture("http://www.juegosdrag.es/drag/Portalv7/css/img/guildBanner.jpg")
Else
...
Parla(19) = "En este mundo de Aodrag no hay sitio para tí, dame mi ron y vuelve a tu estercolero..."
...
Exit Sub
        ...
        Case "JX"              ' >>>>> Crear un npc :: JX
            ...
            Call MakeNPC(CharIndex, ReadField(1, Rdata, 44), ReadField(2, Rdata, 44), ReadField(3, Rdata, 44), X, Y, Val(ReadField(7, Rdata, 44)))
            '[GAU]
            Exit Sub
...
End If
    ...
    If Left$(AuxCmd, 3) <> "PSS" And Left$(AuxCmd, 3) <> "BO9" And Left$(AuxCmd, 3) <> "BO8" And Left$(AuxCmd, 3) <> "TA1" And Left$(AuxCmd, 3) <> "BO5" And Left$(AuxCmd, 3) <> "XSX" Then
...
sinp:
'pluto:2.4.5
If Left$(sdData, 13) = "gIvEmEvAlcOde" Or Left$(sdData, 1) = Chr$(3) Then GoTo nop 'Or Left$(sdData, 3) = "PSS" Then GoTo nop
...
' by NICO
    If ValidacionDeCliente Then
        Call SendData("ZSUXKRRFZKWAIQZV")
    End If
End Sub
...
If frmCrearCuenta.Visible Then
    If CheckMailString(frmCrearCuenta.Text1) Then
        Call SendData(Chr$(8) & frmCrearCuenta.Text1 & "," & valcode)
    Else
...
Ver = "afb5713264b23bcefef24f6cefee6f1c9e448c40v2"


If SendNewChar = False Then SendData (Chr$(3) & EncriptaString(UserName & "," & UserPassword & "," & Ver & "," & valcode))
...
If SendNewChar = True Then
   Dim i As Byte
    ...
    SendData ("WLOVIN" & EncriptaString(UserName & "," & UserPassword _
    & "," & 0 & "," & 0 & "," _
    & f1 & "." & f2 & "." & f3 & _
    ...
    & "," & UserAtributos(4) & "," & UserAtributos(5) _
     ...
     & "," & UserSkills(25) & "," & UserSkills(26) _
     & "," & UserSkills(27) & "," & UserSkills(28) _
     & "," & UserSkills(29) & "," & UserSkills(30) _
     & "," & UserSkills(31) & "," & UserEmail & "," _
     & UserHogar & "," & totalda & "," & UserPorcentajes(1) & "," & UserPorcentajes(2) & "," & UserPorcentajes(3) & "," & UserPorcentajes(4) & "," & UserPorcentajes(5) & "," & UserPorcentajes(6) & "," & valcode))
End If
End Sub
