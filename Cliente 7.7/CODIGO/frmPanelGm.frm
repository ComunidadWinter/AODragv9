...
Begin VB.Form frmPanelGm 
   BackColor       =   &H00000000&
   Caption         =   "Panel de Gm (c) Pluto v.1.0"
   ClientHeight    =   8250
   ClientLeft      =   7575
   ClientTop       =   435
   ClientWidth     =   3975
...
Private Sub cmdCI_Click()
    ...
    If LenB(tStr) <> 0 Then _
        If MsgBox("¿Seguro desea crear el objeto " & tStr & "?", vbYesNo, "Atencion!") = vbYes Then _
                SendData "/mod " & UserName & " objetox " & tStr
End Sub
