...
Begin VB.Form frmEstadisticas 
   ...
   Begin VB.Image Image1 
      Height          =   300
      Left            =   4080
      MouseIcon       =   "FrmEstadisticas.frx":4AEAB
      MousePointer    =   99  'Custom
      Picture         =   "FrmEstadisticas.frx":4BB75
      Top             =   6240
      Width           =   1650
   End
...
Label13.Caption = "Orcos: Poseen Habilidad BESERKER obtienen +30 en Ataque con Armas. (Consultar Manual para más información)"

    Case "VAMPIRO"
   
Label13.Caption = "Vampiros: Regeneran Salud. Transformarción en Murcielagos. Teleportación a Ciudades."
  Case "CICLOPE"
Label13.Caption = "Ciclopes: Golpes críticos x1.25 a otros jugadores (1/15). Además 10% de quedar con 1 de vida al recibir golpe y no morir."
  Case "GOBLIN"
Label13.Caption = "GOBLINS: Roba oro por golpe. Con invisibilidad 30% de no oirse tus pasos. Además 25% no se caiga el inventario al morir."

End Select

Select Case Miclase
Case "Mago"
frmEstadisticas.Label14.Caption = "Magos: Especialistas en todo tipo de Magias. Sus hechizos son los más poderosos y tienen una buena Resistencia Mágica."
