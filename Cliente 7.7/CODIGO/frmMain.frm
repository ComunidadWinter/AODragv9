...
Call AddtoRichTextBox(frmMain.RecTxt, "Para cambiar tu clave escribe el comando /PASSWD (deja un espacio) a continuación escribe tu nueva clave", 187, 87, 87, 0, 0)
End Sub
...
If UCase$(args) = "/BOVEDA" Or UCase$(args) = "/DESCANSAR" Or UCase$(args) = "/MEDITAR" Or UCase$(args) = "/COMERCIAR" Or UCase$(args) = "/ACOMPAÑAR" Or UCase$(args) = "/QUIETO" Then
Call SendData(args)
