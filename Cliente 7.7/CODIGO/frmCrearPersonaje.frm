...
Begin VB.Form frmCrearPersonaje 
   ...
   Begin VB.ComboBox lstProfesion 
      ...
      ForeColor       =   &H00FFFFFF&
      Height          =   300
      ItemData        =   "frmCrearPersonaje.frx":6E94A
      Left            =   2085
      List            =   "frmCrearPersonaje.frx":6E981
   ...
   Begin VB.ComboBox lstGenero 
      ...
      ForeColor       =   &H00FFFFFF&
      Height          =   300
      ItemData        =   "frmCrearPersonaje.frx":6EA1B
      Left            =   2085
      List            =   "frmCrearPersonaje.frx":6EA25
      Style           =   2  'Dropdown List
      TabIndex        =   7
      Top             =   6720
      Width           =   1260
   ...
   Begin VB.ComboBox lstRaza 
      ...
      ForeColor       =   &H00FFFFFF&
      Height          =   300
      ItemData        =   "frmCrearPersonaje.frx":6EA38
      Left            =   2085
      List            =   "frmCrearPersonaje.frx":6EA57
      Style           =   2  'Dropdown List
      TabIndex        =   6
      Top             =   6195
      Width           =   1260
   ...
   Begin VB.Label lblBajaResisMagia 
      ...
      Height          =   315
      Left            =   8280
      MouseIcon       =   "frmCrearPersonaje.frx":6EAA4
      MousePointer    =   99  'Custom
      TabIndex        =   64
      Top             =   6840
      Width           =   315
   ...
   Begin VB.Label lblBajaDañoCC 
      ...
      Height          =   315
      Left            =   8280
      MouseIcon       =   "frmCrearPersonaje.frx":6F76E
      MousePointer    =   99  'Custom
      TabIndex        =   63
      Top             =   6120
      Width           =   315
   ...
   Begin VB.Label lblBajaDañoProye 
      ...
      Height          =   315
      Left            =   7080
      MouseIcon       =   "frmCrearPersonaje.frx":70438
      MousePointer    =   99  'Custom
      TabIndex        =   62
      Top             =   6120
      Width           =   435
   ...
   Begin VB.Label lblBajaDañoMagia 
      ...
      Height          =   315
      Left            =   7080
      MouseIcon       =   "frmCrearPersonaje.frx":71102
      MousePointer    =   99  'Custom
      TabIndex        =   61
      Top             =   6840
      Width           =   435
   ...
   Begin VB.Label lblBajaEvasion 
      ...
      Height          =   315
      Left            =   7080
      MouseIcon       =   "frmCrearPersonaje.frx":71DCC
      MousePointer    =   99  'Custom
      TabIndex        =   60
      Top             =   7560
      Width           =   435
   ...
   Begin VB.Label lblBajaDefensaFisica 
      ...
      Height          =   315
      Left            =   8280
      MouseIcon       =   "frmCrearPersonaje.frx":72A96
      MousePointer    =   99  'Custom
      TabIndex        =   59
      Top             =   7560
      Width           =   315
   ...
   Begin VB.Label lblSubeDefensaFisica 
      ...
      Height          =   315
      Left            =   8760
      MouseIcon       =   "frmCrearPersonaje.frx":73760
      MousePointer    =   99  'Custom
      TabIndex        =   58
      Top             =   7560
      Width           =   315
   ...
   Begin VB.Label lblSubeResisMagia 
      ...
      Height          =   315
      Left            =   8760
      MouseIcon       =   "frmCrearPersonaje.frx":7442A
      MousePointer    =   99  'Custom
      TabIndex        =   57
      Top             =   6840
      Width           =   315
   ...
   Begin VB.Label lblSubeDañoCC 
      ...
      Height          =   315
      Left            =   8760
      MouseIcon       =   "frmCrearPersonaje.frx":750F4
      MousePointer    =   99  'Custom
      TabIndex        =   56
      Top             =   6120
      Width           =   315
   ...
   Begin VB.Label lblSubeEvasion 
      ...
      Height          =   315
      Left            =   7680
      MouseIcon       =   "frmCrearPersonaje.frx":75DBE
      MousePointer    =   99  'Custom
      TabIndex        =   55
      Top             =   7560
      Width           =   315
   ...
   Begin VB.Label lblSubeDañoMagia 
      ...
      Height          =   315
      Left            =   7680
      MouseIcon       =   "frmCrearPersonaje.frx":76A88
      MousePointer    =   99  'Custom
      TabIndex        =   54
      Top             =   6840
      Width           =   315
   ...
   Begin VB.Label lblSubeDañoProye 
      ...
      Height          =   315
      Left            =   7680
      MouseIcon       =   "frmCrearPersonaje.frx":77752
      MousePointer    =   99  'Custom
      TabIndex        =   53
      Top             =   6120
      Width           =   315
   ...
   Begin VB.Label lbBajaInEx 
      ...
      Height          =   135
      Left            =   7440
      MouseIcon       =   "frmCrearPersonaje.frx":7841C
      MousePointer    =   99  'Custom
      TabIndex        =   45
      Top             =   3960
      Visible         =   0   'False
   ...
   Begin VB.Label lbBajaCaEx 
      ...
      Height          =   135
      Left            =   7440
      MouseIcon       =   "frmCrearPersonaje.frx":790E6
      MousePointer    =   99  'Custom
      TabIndex        =   44
      Top             =   4320
      Visible         =   0   'False
   ...
   Begin VB.Label lbBajaCoEx 
      ...
      Height          =   135
      Left            =   7440
      MouseIcon       =   "frmCrearPersonaje.frx":79DB0
      MousePointer    =   99  'Custom
      TabIndex        =   43
      Top             =   4680
      Visible         =   0   'False
   ...
   Begin VB.Label lbSubeCoEx 
      ...
      Height          =   135
      Left            =   7920
      MouseIcon       =   "frmCrearPersonaje.frx":7AA7A
      MousePointer    =   99  'Custom
      TabIndex        =   42
      Top             =   4680
      Visible         =   0   'False
   ...
   Begin VB.Label lbSubeCaEx 
      ...
      Height          =   135
      Left            =   7920
      MouseIcon       =   "frmCrearPersonaje.frx":7B744
      MousePointer    =   99  'Custom
      TabIndex        =   41
      Top             =   4320
      Visible         =   0   'False
   ...
   Begin VB.Label lbSubeInEx 
      ...
      Height          =   135
      Left            =   7920
      MouseIcon       =   "frmCrearPersonaje.frx":7C40E
      MousePointer    =   99  'Custom
      TabIndex        =   40
      Top             =   3960
      Visible         =   0   'False
   ...
   Begin VB.Label lbBajaFuEx 
      ...
      Height          =   195
      Left            =   7440
      MouseIcon       =   "frmCrearPersonaje.frx":7D0D8
      MousePointer    =   99  'Custom
      TabIndex        =   39
      Top             =   3045
      Visible         =   0   'False
   ...
   Begin VB.Label lbBajaAgEx 
      ...
      Height          =   195
      Left            =   7440
      MouseIcon       =   "frmCrearPersonaje.frx":7DDA2
      MousePointer    =   99  'Custom
      TabIndex        =   38
      Top             =   3405
      Visible         =   0   'False
   ...
   Begin VB.Label lbSubeAgEx 
      ...
      Height          =   195
      Left            =   7920
      MouseIcon       =   "frmCrearPersonaje.frx":7EA6C
      MousePointer    =   99  'Custom
      TabIndex        =   37
      Top             =   3405
      Visible         =   0   'False
   ...
   Begin VB.Label lbSubeFuEx 
      ...
      Height          =   255
      Left            =   7920
      MouseIcon       =   "frmCrearPersonaje.frx":7F736
      MousePointer    =   99  'Custom
      TabIndex        =   36
      Top             =   3000
      Visible         =   0   'False
   ...
   Begin VB.Label lbBajaCo 
      ...
      Height          =   315
      Left            =   4680
      MouseIcon       =   "frmCrearPersonaje.frx":80400
      MousePointer    =   99  'Custom
      TabIndex        =   28
      Top             =   4380
      Width           =   435
   ...
   Begin VB.Label lbBajaCa 
      ...
      Height          =   195
      Left            =   4680
      MouseIcon       =   "frmCrearPersonaje.frx":810CA
      MousePointer    =   99  'Custom
      TabIndex        =   27
      Top             =   4080
      Width           =   435
   ...
   Begin VB.Label lbBajaIn 
      ...
      Height          =   195
      Left            =   4680
      MouseIcon       =   "frmCrearPersonaje.frx":81D94
      MousePointer    =   99  'Custom
      TabIndex        =   26
      Top             =   3720
      Width           =   435
   ...
   Begin VB.Label lbBajaAg 
      ...
      Height          =   195
      Left            =   4680
      MouseIcon       =   "frmCrearPersonaje.frx":82A5E
      MousePointer    =   99  'Custom
      TabIndex        =   25
      Top             =   3360
      Width           =   435
   ...
   Begin VB.Label lbBajaFu 
      ...
      Height          =   315
      Left            =   4680
      MouseIcon       =   "frmCrearPersonaje.frx":83728
      MousePointer    =   99  'Custom
      TabIndex        =   24
      Top             =   2880
      Width           =   435
   ...
   Begin VB.Label lbSubeCo 
      ...
      Height          =   300
      Left            =   5280
      MouseIcon       =   "frmCrearPersonaje.frx":843F2
      MousePointer    =   99  'Custom
      TabIndex        =   23
      Top             =   4380
      Width           =   435
   ...
   Begin VB.Label lbSubeCa 
      ...
      Height          =   285
      Left            =   5280
      MouseIcon       =   "frmCrearPersonaje.frx":850BC
      MousePointer    =   99  'Custom
      TabIndex        =   22
      Top             =   4005
      Width           =   435
   ...
   Begin VB.Label lbSubeIn 
      ...
      Height          =   300
      Left            =   5280
      MouseIcon       =   "frmCrearPersonaje.frx":85D86
      MousePointer    =   99  'Custom
      TabIndex        =   21
      Top             =   3645
      Width           =   435
   ...
   Begin VB.Label lbSubeAg 
      ...
      Height          =   285
      Left            =   5280
      MouseIcon       =   "frmCrearPersonaje.frx":86A50
      MousePointer    =   99  'Custom
      TabIndex        =   20
      Top             =   3270
      Width           =   435
   ...
   Begin VB.Label lbSubeFu 
      ...
      Height          =   315
      Left            =   5280
      MouseIcon       =   "frmCrearPersonaje.frx":8771A
      MousePointer    =   99  'Custom
      TabIndex        =   19
      Top             =   2880
      Width           =   435
   ...
   Begin VB.Label Label3 
      ...
      Height          =   255
      Left            =   7440
      MouseIcon       =   "frmCrearPersonaje.frx":883E4
      MousePointer    =   99  'Custom
      TabIndex        =   16
      Top             =   8640
      Visible         =   0   'False
   ...
   Begin VB.Image boton 
      ...
      Index           =   1
      Left            =   120
      MouseIcon       =   "frmCrearPersonaje.frx":890AE
      MousePointer    =   99  'Custom
      Top             =   8520
      Width           =   1965
   End
   Begin VB.Image boton 
      ...
      Index           =   0
      Left            =   9840
      MouseIcon       =   "frmCrearPersonaje.frx":89D78
      MousePointer    =   99  'Custom
      Top             =   8520
      Width           =   2025
   End
...
MsgBox "- NOMBRE DE PERSONAJE NO PERMITIDO - Por favor compruebe que no lleve adornos de cualquier tipo (IXI IOI OoO ...), clases de personajes incluidas en el nombre (Talador, Minero...), Dobles espacios, Palabras mal sonantes o cualquier otro tipo de cosas que no lo hagan apropiado para un juego de Rol. Gracias."
Exit Function
End If
Next
...
Select Case Index
    ...
    Case "Humano"
        ...
        'End If
    Case "Elfo"
        If UserClase = "Guerrero" Or UserClase = "Cazador" Or UserClase = "Pirata" _
        Or UserClase = "Bandido" Or UserClase = "Ladron" Or UserClase = "Leñador" _
        Or UserClase = "Ermitaño" Or UserClase = "Pescador" Or UserClase = "Carpintero" _
        Or UserClase = "Herrero" Or UserClase = "Minero" Or UserClase = "Domador" Then
        MsgBox ("Los Elfos no pueden ser: Guerreros, Cazadores, Piratas, Bandidos, Ladrones, Leñadores, Ermitaños, Pescadores, Carpinteros, Herreros, Mineros o Domadores.")
        Exit Sub
        End If
     Case "Elfo Oscuro"
    ...
    Case "Orco"
        If UserClase = "Paladin" Or UserClase = "Asesino" Or UserClase = "Clerigo" _
        Or UserClase = "Bardo" Or UserClase = "Druida" Or UserClase = "Ladron" _
        Or UserClase = "Mago" Or UserClase = "Arquero" Then
        MsgBox ("Los Orcos no pueden ser: Paladines, Asesinos, Clerigos, Bardos, Druidas, Ladrones, Magos o Arqueros.")
        Exit Sub
        End If
        ...
        MsgBox ("Los Ciclopes no pueden ser: Cazadores, Druidas, Arqueros o Magos.")
        Exit Sub
        End If
...
Label5.Caption = "Aldea de Humanos"
...
Label5.Caption = "Aldea de Gnomos"
    Case "ORCO"
       ' LabelBonus(0).Caption = "+4"
       'LabelBonus(1).Caption = "-3"
...
Label5.Caption = "Poblado Orco"
    ...
    Case "VAMPIRO"
      ...
      ' LabelBonus(3).Caption = "+0"
       'LabelBonus(4).Caption = "+2"
Label5.Caption = "Aldea de Vampiros"
Label1.Caption = "Vampiros: Regeneran Salud. Transformarción en Murcielagos. Teleportación a Ciudades."
Label5.Caption = "Aldea de Vampiros"
  Case "CICLOPE"
Label1.Caption = "Ciclopes: Golpes críticos x1.25 a otros jugadores (1/15). Además 10% de quedar con 1 de vida al recibir golpe y no morir."
  Case "GOBLIN"
Label5.Caption = "Aldea de Gnomos"
Label1.Caption = "GOBLINS: Roba oro por golpe. Con invisibilidad 30% de no oirse tus pasos. Además 25% no se caiga el inventario al morir."
