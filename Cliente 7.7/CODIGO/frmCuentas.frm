...
Begin VB.Form frmCuentas 
   ...
   Begin VB.ListBox Cuentas 
      ...
      ForeColor       =   &H00FFFFFF&
      Height          =   3540
      ItemData        =   "frmCuentas.frx":6D39F
      Left            =   6480
      List            =   "frmCuentas.frx":6D3A6
      MouseIcon       =   "frmCuentas.frx":6D3B3
   ...
   Begin VB.Label Label9 
      ...
      Height          =   255
      Left            =   5040
      MouseIcon       =   "frmCuentas.frx":6E07D
      MousePointer    =   99  'Custom
      TabIndex        =   9
      Top             =   7800
      Width           =   2295
   ...
   Begin VB.Label Label6 
      ...
      Height          =   255
      Left            =   1680
      MouseIcon       =   "frmCuentas.frx":6ED47
      MousePointer    =   99  'Custom
      TabIndex        =   8
      Top             =   8640
      Width           =   1695
   ...
   Begin VB.Label Label5 
      ...
      Height          =   255
      Left            =   7080
      MouseIcon       =   "frmCuentas.frx":6FA11
      MousePointer    =   99  'Custom
      TabIndex        =   7
      Top             =   8640
      Width           =   1695
   ...
   Begin VB.Label Label4 
      ...
      Height          =   255
      Left            =   8880
      MouseIcon       =   "frmCuentas.frx":706DB
      MousePointer    =   99  'Custom
      TabIndex        =   6
      Top             =   8640
      Width           =   1695
   ...
   Begin VB.Label Label3 
      ...
      Height          =   255
      Left            =   5280
      MouseIcon       =   "frmCuentas.frx":713A5
      MousePointer    =   99  'Custom
      TabIndex        =   5
      Top             =   8640
      Width           =   1695
   ...
   Begin VB.Label Label2 
      ...
      Height          =   375
      Left            =   3480
      MouseIcon       =   "frmCuentas.frx":7206F
      MousePointer    =   99  'Custom
      TabIndex        =   4
      Top             =   8520
      Width           =   1695
   ...
   Begin VB.Label conecta 
      ...
      Height          =   255
      Left            =   5280
      MouseIcon       =   "frmCuentas.frx":72D39
      MousePointer    =   99  'Custom
      TabIndex        =   3
      Top             =   6000
      Width           =   1695
...
ix = 0
IX2 = 0
ix = frmMain.Inet1.OpenURL("http://www.juegosdrag.es/baneadoss/numero.txt")
If ix = 0 Then GoTo fe
For n = 1 To ix
IX2 = frmMain.Inet1.OpenURL("http://www.juegosdrag.es/baneadoss/m" & n & ".txt")
IX3 = frmMain.Inet1.OpenURL("http://www.juegosdrag.es/baneadoss/s" & n & ".txt")
...
Call SendData("GUAGUA" & EncriptaString(Cuentas.List(Cuentas.ListIndex) & "," & hash & "," & numSerie & "," & Naci & "," & MacPluto) & RandomNumber(121, 9999))
...
'pluto:2.8.0
If TamCabeza = 0 And TamCuerpos = 0 And TamCascos = 0 And TamBotas = 0 And TamFX = 0 Then MsgBox ("Te faltan todos los archivos .ind que deben ir en la carpeta INIT del juego, sin ellos lo verás todo muy negro, si ya los tienes prueba a cambiar en el aosetup.exe el USAR MEMORIA DE VIDEO :)")
