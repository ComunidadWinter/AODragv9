...
Begin VB.Form frmTorneoCrear 
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.OptionButton Option6 
         ...
         Height          =   315
         Left            =   0
         Picture         =   "frmTorneoCrear.frx":2012
         Style           =   1  'Graphical
         TabIndex        =   17
         Top             =   0
         Value           =   -1  'True
      ...
      Begin VB.OptionButton Option5 
         ...
         DisabledPicture =   "frmTorneoCrear.frx":293B
         Height          =   315
         Left            =   0
         Picture         =   "frmTorneoCrear.frx":5C3DD
         Style           =   1  'Graphical
         TabIndex        =   16
         Top             =   240
         Width           =   1455
   ...
   Begin VB.CommandButton Command2 
      ...
      Height          =   435
      Left            =   4320
      Picture         =   "frmTorneoCrear.frx":5CD06
      Style           =   1  'Graphical
      TabIndex        =   14
      Top             =   6480
      Width           =   1575
   ...
   Begin VB.CheckBox Check1 
      ...
      Height          =   435
      Left            =   1560
      Picture         =   "frmTorneoCrear.frx":5D9BB
      Style           =   1  'Graphical
      TabIndex        =   7
      Top             =   3060
      Width           =   2655
   ...
   Begin VB.OptionButton Option1 
      ...
      Height          =   435
      Left            =   1560
      Picture         =   "frmTorneoCrear.frx":5E2E4
      Style           =   1  'Graphical
      TabIndex        =   6
      Top             =   1740
      Width           =   2655
   ...
   Begin VB.OptionButton Option2 
      ...
      DisabledPicture =   "frmTorneoCrear.frx":5EC0D
      BeginProperty Font 
         Name            =   "Arial"
         Size            =   15.75
         Charset         =   0
      ...
      Height          =   435
      Left            =   1560
      Picture         =   "frmTorneoCrear.frx":B86AF
      Style           =   1  'Graphical
      TabIndex        =   1
      Top             =   2400
      Value           =   -1  'True
   ...
   Begin VB.CommandButton Command1 
      ...
      Height          =   435
      Left            =   240
      Picture         =   "frmTorneoCrear.frx":B8FD8
      Style           =   1  'Graphical
      TabIndex        =   0
      Top             =   6480
      Width           =   1575
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.OptionButton Option4 
         ...
         BackColor       =   &H80000005&
         Caption         =   "Mínimo"
         DisabledPicture =   "frmTorneoCrear.frx":B9C8D
         ForeColor       =   &H80000008&
         Height          =   315
         Left            =   0
         Picture         =   "frmTorneoCrear.frx":11372F
         Style           =   1  'Graphical
         TabIndex        =   10
         Top             =   240
         Value           =   -1  'True
      ...
      Begin VB.OptionButton Option3 
         ...
         Height          =   315
         Left            =   0
         Picture         =   "frmTorneoCrear.frx":114058
         Style           =   1  'Graphical
         TabIndex        =   9
         Top             =   0
         Width           =   975
   ...
   Begin VB.Frame Frame3 
      ...
      Begin VB.OptionButton Option7 
         ...
         Height          =   255
         Left            =   0
         Picture         =   "frmTorneoCrear.frx":114981
         Style           =   1  'Graphical
         TabIndex        =   20
         Top             =   0
         Width           =   1695
      ...
      Begin VB.OptionButton Option8 
         ...
         Height          =   255
         Left            =   0
         Picture         =   "frmTorneoCrear.frx":1152AA
         Style           =   1  'Graphical
         TabIndex        =   19
         Top             =   240
         Width           =   1695
   ...
   Begin VB.Image Image2 
      ...
      Height          =   255
      Left            =   1080
      Picture         =   "frmTorneoCrear.frx":115BD3
      Stretch         =   -1  'True
      Top             =   1800
      Visible         =   0   'False
      Width           =   315
   ...
   Begin VB.Image Image1 
      ...
      Height          =   255
      Left            =   1080
      Picture         =   "frmTorneoCrear.frx":1162A5
      Stretch         =   -1  'True
      Top             =   2520
      Width           =   315
   End
