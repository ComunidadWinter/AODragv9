...
Const tiles_Area_X         As Integer = 11
Const tiles_Area_Y         As Integer = 11
...
Public Sub direccionadoAreas(ByVal X As Integer, ByVal Y As Integer, ByVal Head As Byte, ByRef stX As Integer, _
                             ByRef lastX As Integer, ByRef stY As Integer, ByRef lastY As Integer)
