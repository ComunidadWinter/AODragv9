                ...
                If UserIndex <> 0 Then
                    ...
                    If getInterval(TActual, .SpawnTime) >= 5000 Then ' 0.13.5
                        ...
                        If Not UserList(UserIndex).flags.CentinelaOK Then
                            Call WritePlayWave(UserIndex, 227, NPCList(.NPCIndex).Pos.X, NPCList(.NPCIndex).Pos.Y)
                ...
                If Not .flags.CentinelaOK And .flags.CentinelaIndex = 0 Then
                    ...
                    With Centinela(CentinelaIndex)
                        ...
                        If .NPCIndex <> 0 Then
                            ...
                            Call WriteChatOverHead(LoopC, "Saludos " & UserList(LoopC).Name & ", soy el Centinela, guardían de los recursos. Me gustaría que escribas /CENTINELA " & .clave & " en no más de un minutos.", CStr(NPCList(.NPCIndex).Char.CharIndex), vbGreen, True)
...
'*************************************************
    ...
    With Centinela(CentinelaIndex)
        ...
        If .RevisandoUserIndex = UserIndex Then
            ...
            If Not UserList(UserIndex).flags.CentinelaOK Then
                Call WriteChatOverHead(UserIndex, "¡La clave que te he dicho es /CENTINELA " & .clave & ", escríbelo rápido!", NPCList(.NPCIndex).Char.CharIndex, vbGreen, True)
        ...
        With Centinela(Index)
            ...
            If .Activo Then
                ...
                Else
                    ...
                    Call WriteChatOverHead(UserIndex, "¡" & UserList(UserIndex).Name & ", tienes un minuto más para responder! Debes escribir /CENTINELA " & .clave & ".", CStr(NPCList(.NPCIndex).Char.CharIndex), vbRed, True)
